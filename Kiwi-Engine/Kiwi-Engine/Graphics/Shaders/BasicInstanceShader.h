#ifndef _KIWI_BASICINSTANCESHADER_H_
#define _KIWI_BASICINSTANCESHADER_H_
...
namespace Kiwi
{
	...
	public:
		...
		BasicInstanceShader( const std::wstring shaderName, const std::wstring renderer, const std::wstring vsFile, const std::wstring psFile );
		~BasicInstanceShader();
